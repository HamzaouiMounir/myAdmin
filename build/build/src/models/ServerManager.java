...
public class ServerManager extends Thread {
	...
	public boolean pingByHost(String hostAdress, int timeout) throws UnknownHostException, IOException {

		return InetAddress.getByName(hostAdress).isReachable(timeout);
	}
